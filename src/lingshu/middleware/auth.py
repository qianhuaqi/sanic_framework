...
from lingshu.middleware.crypt_des import encrypt_data, decrypt_data
from lingshu.middleware.utils import md5_upper, get_client_ip
from lingshu.system import sanic_adapter

class Auth:
    def __init__(self, request: Request):
        self.request = request
        self.config = sanic_adapter.get_request_config(self.request).auth
    ...
    async def decode_jwt(self, token):
        ...
        try:
            ...
            logger = sanic_adapter.get_optional_request_resource(self.request, "logger")
    ...
    async def check_token(self):
        ...
        white_ip_list = getattr(sanic_adapter.get_request_config(self.request), "auth_white_ip_list", [])
